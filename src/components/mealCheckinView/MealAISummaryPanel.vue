<template>
  <div class="meal-ai-summary-panel">
    <div class="summary-header">
      <h3 class="summary-title">饮食AI总结</h3>
    </div>
...
const actualSummary = computed(() => {
  return (props.mealSummary as any)?.data?.meal_ai_summary || 
         (props.mealSummary as any)?.meal_ai_summary ||
         null
})
...
<style lang="scss" scoped src="@/scss/components/mealCheckinView/MealAISummaryPanel.scss"></style>
