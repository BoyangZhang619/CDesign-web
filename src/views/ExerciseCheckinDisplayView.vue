                    ...
                    <form v-if="isFormExpanded" @submit.prevent="handleAddRecord" class="exercise-form">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input id="startTime" v-model="form.start_time" type="datetime-local"
                                    class="form-input" />
                            </div>

                            <div class="form-group">
                                <label for="endTime" class="form-label">结束时间</label>
                                <input id="endTime" v-model="form.end_time" type="datetime-local" class="form-input" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                ...
                                <textarea id="note" v-model="form.note" class="form-textarea" rows="3"
                        ...
                        <div v-for="record in records" :key="record.exercise_record_id" class="record-card">
                            <div class="record-header">
                                <div class="record-main">
                                    ...
                                    <p class="record-time">{{ formatTime(record.start_time) }} - {{
                                        formatTime(record.end_time) }}</p>
                                </div>
                                <div class="record-actions">
                                    <router-link :to="`/exercise/checkin-edit?id=${record.exercise_record_id}`"
                                        class="btn-edit" title="编辑">
                                        编辑
                                    </router-link>
                                    <button class="btn-delete" @click="deleteExerciseRecord(record.exercise_record_id)"
                                        title="删除">
                                        删除
                                    </button>
                                </div>
                            ...
                            <div class="record-details">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span v-else class="detail-value">{{ formatCaloriesBurned(record.calories_burned)
                                        }}</span>
                                </div>
