            ...
            <div class="exercise-wrapper">
                ...
                <section v-if="records.length > 0" class="form-section">
                    ...
                    <div class="records-list">
                        <div v-for="record in records" :key="record.exercise_record_id" class="record-item"
                            @click="selectRecord(record)">
                            <div class="record-select">
                                <input type="radio" :name="'record-' + record.exercise_record_id"
                                    :value="record.exercise_record_id" v-model="selectedRecordId" class="radio-input" />
                            </div>
                            <div class="record-info">
                                ...
                                <p class="record-detail">{{ record.duration_min }} 分钟 · {{
                                    getIntensityText(record.intensity) }}</p>
                            </div>
                    ...
                    <form @submit.prevent="handleUpdate" class="exercise-form">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select v-model="selectedRecord.activity_type" class="form-input">
                                    <option v-for="option in activityTypeOptions" :key="option.value"
                                        :value="option.value">
                                        {{ option.label }}
                                    </option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select v-model="selectedRecord.intensity" class="form-input">
                                    <option v-for="option in intensityOptions" :key="option.value"
                                        :value="option.value">
                                        {{ option.label }}
                                    </option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input id="startTime" v-model="selectedRecord.start_time" type="datetime-local"
                                    class="form-input" />
                            </div>

                            <div class="form-group">
                                <label for="endTime" class="form-label">结束时间</label>
                                <input id="endTime" v-model="selectedRecord.end_time" type="datetime-local"
                                    class="form-input" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group full-width">
                                ...
                                <textarea id="note" v-model="selectedRecord.note" class="form-textarea" rows="3"
                                    placeholder="记录运动中的特殊情况" maxlength="200"></textarea>
                            </div>
                        </div>
